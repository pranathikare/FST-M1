...
public class Activity5 {
  ...
  public void loginWithvalidCredentials() {
	  ...
	  driver.findElement(
              MobileBy.AndroidUIAutomator(UiScrollable + ".scrollForward(5).scrollIntoView(textContains(\"Login Form\"))"))
              .click();
	  
//	  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[@text='Login Form']")));
//	  driver.findElementByXPath("//android.view.View[@text='Login Form']").click();
	  try {
		Thread.sleep(3000);
...
//	  driver.findElementById("password").sendKeys("password");
  ...
  public void loginWithInvalidCredentials() {
	  ...
	  wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.xpath("//*[@resource-id='action-confirmation']")));
	  String msg = driver.findElementByXPath("//*[@resource-id='action-confirmation']").getText();
	  System.out.println(msg);
